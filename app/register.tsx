...
import { User, Mail, Lock, Flame } from 'lucide-react-native';
import { Colors } from '@/constants/colors';
import { useAuth } from '@/providers/AuthProvider';

export default function RegisterScreen() {
  const { isAuthenticated, register, registerPending, registerError, resetRegisterError } =
    useAuth();
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              disabled={registerPending || !canSubmit}
              activeOpacity={0.8}
